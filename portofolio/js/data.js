const DATA = {
  ...
  hero: {
    ...
    p1: "Seorang Web Developer & UI/UX Design yang berdedikasi untuk membangun solusi digital yang berdampak. Saya spesialis dalam pengembangan platform web yang skalabel dan design tampilan yang user friendly menggunakan tech stack seperti PHP, React.js, dan Figma.",
  ...
  skills: [
    ...
    { name: "Java",       icon: "devicon-java-plain colored",        category: ["utama","backend"],  colorClass: "skill-java" },
    { name: "TailwindCSS",icon: "devicon-tailwindcss-plain colored", category: ["utama","frontend"], colorClass: "skill-tailwind" },
    { name: "PHP",        icon: "devicon-php-plain colored",         category: ["utama","backend"],  colorClass: "skill-php" },
    { name: "MySQL",      icon: "devicon-mysql-plain colored",       category: ["utama","database"], colorClass: "skill-mysql" },
    { name: "React.js",   icon: "devicon-react-original colored",    category: ["utama","frontend"], colorClass: "skill-react" },
    { name: "Git",        icon: "devicon-git-plain colored",         category: ["utama","tools"],    colorClass: "skill-git" },
    { name: "GitHub",     icon: "devicon-github-original",           category: ["utama","tools"],    colorClass: "skill-github" },
    { name: "npm",        icon: "devicon-npm-original-wordmarkcolored",category: ["utama","tools"],  colorClass: "skill-npm" },
    { name: "Figma",      icon: "devicon-figma-plain colored",       category: ["utama","tools"],    colorClass: "skill-figma" },
  ],
  ...
  about: {
    paragraphs: [
      ...
      {
        id: "Dalam hal teknis, saya sehari-hari berkutat dengan PHP dan React Js untuk membangun sisi engine website yang tangguh dan interaktif. Namun, sebelum masuk ke bagian kode, saya biasanya menuangkan kreativitas saya di Figma terlebih dahulu. Di sana, saya merancang tampilan antarmuka yang modern dan memastikan pengalaman pengguna (user experience) terasa mulus dan nyaman saat digunakan.",
        en: "On the technical side, I spend my days working with PHP and React Js to build robust, interactive website engines. But before jumping into code, I usually pour my creativity into Figma first. There, I craft modern interfaces and make sure the user experience feels smooth and comfortable to use."
      },
      {
    ...
    careers: [
      {
        ...
        detail: {
          id: "Mendedikasikan keahlian saya sebagai siswa Taruna Bangsa untuk merancang, membangun prototipe, dan mengimplementasikan antarmuka aplikasi atau situs web yang estetis, intuitif, dan konsisten demi kemajuan digital institusi.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          desc: { id: "Framework JavaScript untuk UI", en: "JavaScript framework for building user interfaces." }
        }
      ]
    }
  ],
  ...
  contacts: [
    ...
    },
    {
      ...
      icon: "github",
      theme: "theme-navy",
      url: "https://github.com/fm1181546-html/"
    }
  ],
